...
const Hero = () => {
  ...
  const handleSendCurrencyChange = (e) => {
    ...
    const conversionRate =
      exchangeRates[selectedSendCurrency]?.[receiveCurrency] || 1;
  ...
  const handleReceiveCurrencyChange = (e) => {
    ...
    const conversionRate =
      exchangeRates[sendCurrency]?.[selectedReceiveCurrency] || 1;
    setConvertedAmount(sendAmount * conversionRate);
  };
  ...
  return (
    ...
    >
      ...
      >
        <Box color={"#fff"} w={["100%", "100%", "100%", "50%"]}>
          ...
          <Text
            ...
            color={"#FEFEFE"}
          >
            Our industry-leading technology protects your money andguarantees it
            arrives safely everytime
          </Text>
          <Flex justify={["center", "center", "center", "start"]}>
            <CustomButton
        ...
        <Box
          p={"20px"}
          margin={["0px auto", "0px auto", "0px auto", "0px"]}
          bg={"#fff"}
          borderRadius={"10px"}
          // flex={0.6}
          maxW={"555px"}
          w={["100%", "100%", "100%", "50%"]}
          boxShadow="0 4px 30px rgba(255, 255, 255, 0.9)"
        >
          <Text textAlign={"center"} color={"#FF0000"}>
            Best rate guarantee |{" "}
            <span style={{ fontWeight: "bold" }}>
              New customer rate-980 NGN
            </span>
          </Text>
          <Flex justify={"center"}>
            <Text
              ...
              borderRadius={"50px"}
            >
              <span style={{ fontWeight: "500" }}>Rate</span> - 1 AUD = 985 NGN
            </Text>
          </Flex>
          ...
          >
            ...
            <Box border={"1px solid #656565"} borderRadius={"50px"} px="30px">
              <Flex align="center">
                <Image
                  src={getCurrencyFlag(sendCurrency)}
                  alt="currency flag"
                  boxSize="20px"
                  mr="10px"
                />
          ...
          >
            ...
            <Box border={"1px solid #656565"} borderRadius={"50px"} px="30px">
              <Flex align="center">
                <Image
                  src={recieveCurrencyFlag(receiveCurrency)}
                  alt="currency flag"
                  boxSize="20px"
                  mr="10px"
                />
          ...
          >
            ...
            <Box>
              <Select variant="Unstyled" iconColor="red.500"></Select>
            </Box>
          </Flex>
